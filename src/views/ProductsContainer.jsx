...
const UsersContainer = () => {
    ...
    const fetchUsersData = async () => {
        const response = await ProductService.getUsers(state.keyword, state.page, state.size);
        if (response.success) {
    ...
    const handleCreateUser = async () => {
        ...
        const response = isUpdate ? await ProductService.updateUser(currentUser) : await ProductService.createUser(currentUser);
        if (response.success) {
            fetchUsersData();
    ...
    const handleDeleteUser = async (userId) => {
        const result = await ProductService.deleteUser(userId);
        if (result.success) {
            fetchUsersData();
